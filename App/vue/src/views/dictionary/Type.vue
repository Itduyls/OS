...
const onSort = (event) => {
  ...
  if (event.sortField != "doc_type_id") {
    options.value.sort +=
      ",doc_type_id " + (event.sortOrder == 1 ? " ASC" : " DESC");
  }
...
const onFilter = (event) => {
  ...
  for (const [key, value] of Object.entries(event.filters)) {
    if (key != "global") {
      let obj = {
        key: key != "doc_type_name" ? "doc_type_name" : key,
          ...
          <div class="col-12 p-0">
            ...
            <div class="col-12 p-0 my-3 flex">
              <div class="col-6 flex p-0">
                ...
                <InputNumber v-model="caType.is_order" class="col-6 p-0 ip36" />
              </div>
              <div class="col-6 flex p-0">
                <div class="pb-2 col-6 p-0 line-height-4 px-2">Trạng thái</div>
                <InputSwitch v-model="caType.status" class="col-6 p-0 ip36" />
              </div>
            </div>
          </div>
        </div>
