...
const onSort = (event) => {
  ...
  if (event.sortField != "field_id") {
    options.value.sort +=
      ",field_id " + (event.sortOrder == 1 ? " ASC" : " DESC");
  }
...
const onCheckBox = (value) => {
  ...
  axios
    .put(baseURL + "/api/ca_fields/Update_StatusField_Books", data, config)
    .then((response) => {
      if (response.data.err != "1") {
        swal.close();
          ...
          <div class="col-12 p-0">
            ...
            <div class="col-12 p-0 my-3 flex">
              <div class="col-6 flex p-0">
                ...
                <InputNumber v-model="field.is_order" class="col-6 p-0 ip36" />
              </div>
              <div class="col-6 flex p-0">
                <div class="pb-2 col-6 p-0 line-height-4 px-2">Trạng thái</div>
                <InputSwitch v-model="field.status" class="col-6 p-0 ip36" />
              </div>
            </div>
          </div>
        </div>
