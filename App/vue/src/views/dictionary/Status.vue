...
const onPage = (event) => {
  if (event.page == 0) {
    ...
    options.value.id = datalists.value[datalists.value.length - 1].status_id;
    options.value.IsNext = true;
  } else if (event.page < options.value.PageNo) {
    //Trang trước
    options.value.id = datalists.value[0].status_id;
    options.value.IsNext = false;
  }
...
const onSort = (event) => {
  ...
  if (event.sortField != "status_id") {
    options.value.sort +=
      ",status_id " + (event.sortOrder == 1 ? " ASC" : " DESC");
  }
...
const changeColor = (color) => {
 ...
 caStatus.value.main_color= `rgba(${r}, ${g}, ${b}, ${a})`
};
const changeColor1 = (color) => {
   const { r, g, b, a } = color.rgba
   caStatus.value.background_color= `rgba(${r}, ${g}, ${b}, ${a})`
};
onMounted(() => {
        ...
        <div style="display: flex" class="field col-12 md:col-12">
          <div class="col-12 p-0">
            ...
            <div class="col-12 p-0 my-3 flex">
              <div class="col-6 flex p-0 relative">
                <div class="pb-2 col-6 p-0 line-height-4">Màu chính</div>
                <!-- <ColorPicker
                  v-model="caStatus.main_color"
                ...
                <div class="col-6 p-0 m-0 ">
                  <div class="flex col-12  p-0 m-0">
                    ...
                    ></InputText>
                    <Button @click="showMainColor" class="col-2 p-0 m-0 ip36" :style="{backgroundColor:caStatus.main_color}"></Button>
                  </div>
                  <div v-if="isShowMain" class="col-12  p-0 m-0 pt-2">
                    <ColorPicker
                      class="col-6 p-0 ip36 h-full"
                      theme="light"
              ...
              <div class="col-6 flex p-0">
                <div class="pb-2 col-6 p-0 line-height-4 px-2 text-center">Màu nền</div>
                <div class="col-6 p-0 m-0 ">
                  <div class="flex col-12  p-0 m-0">
                    <InputText
                      class="col-10 p-0 m-0 ip36 px-2"
                      v-model="caStatus.background_color"
                      
                    ></InputText>
                    <Button @click="showMainColor" class="col-2 p-0 m-0 ip36" :style="{backgroundColor:caStatus.background_color}"></Button>
                  </div>
                  <div v-if="isShowMain" class="col-12  p-0 m-0 pt-2">
                    <ColorPicker
                      class="col-6 p-0 ip36 h-full"
            ...
            <div class="col-12 p-0 my-3 flex">
              ...
              <div class="col-6 flex p-0">
                <div class="pb-2 col-6 p-0 line-height-4 px-2 text-center">Trạng thái</div>
                <InputSwitch v-model="caStatus.status" class="col-6 p-0 ip36" />
              </div>
            </div>
            <div class="col-12 p-0 my-3 flex">
              <div class="col-6 flex p-0">
