...
Case = {"Duan_ID": "VUE", "Case_Name": "Test chức năng đăng nhập", "Tukhoa": "Login",
        "IsUrl": Const.BaseUrl, "FileTest": "logintest.py", "CodeTest": ""}
Case["CodeTest"] = Helper.base64Img("login.py")
options = Options()
#options.headless = True
driver = webdriver.Chrome(
    "chromedriver.exe", options=options)  # import trình duyệt
...
if swal2 and swal2.text == "Tên đăng nhập hoặc mật khẩu không đúng!":
    ...
    driver.find_element(By.CSS_SELECTOR,
                        "body > div.swal2-container.swal2-center.swal2-backdrop-show > div > div.swal2-actions > button.swal2-confirm.swal2-styled.swal2-default-outline").click()
else:
...
print(res.content)
with open('output/login.json', 'w', encoding='utf-8') as f:
