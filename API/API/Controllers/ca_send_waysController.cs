...
namespace API.Controllers
{
    ...
    public class ca_send_waysController : ApiController
    {
        ...
        [HttpPost]
        public async Task<HttpResponseMessage> Add_send_way(doc_ca_send_ways send_Ways)
        {
        ...
        [HttpPut]
        public async Task<HttpResponseMessage> Update_send_ways(doc_ca_send_ways send_Ways)
        {
            var identity = User.Identity as ClaimsIdentity;
            string fdlang = "";
            IEnumerable<Claim> claims = identity.Claims;
        ...
        [HttpDelete]
        public async Task<HttpResponseMessage> Delete_send_ways([FromBody] List<int> id)
        {
            var identity = User.Identity as ClaimsIdentity;
            IEnumerable<Claim> claims = identity.Claims;
            try
        ...
        [HttpPut]
        public async Task<HttpResponseMessage> Update_StatusSend_Way(Trangthai trangthai)
        {
            var identity = User.Identity as ClaimsIdentity;
            IEnumerable<Claim> claims = identity.Claims;
            try
