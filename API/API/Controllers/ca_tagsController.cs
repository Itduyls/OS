...
namespace API.Controllers
{
    ...
    public class ca_tagsController : ApiController
    {
        ...
        [HttpPost]
        public async Task<HttpResponseMessage> Add_tag(doc_ca_tags Tag)
        {
        ...
        [HttpPut]
        public async Task<HttpResponseMessage> Update_tag(doc_ca_tags Tag)
        {
            var identity = User.Identity as ClaimsIdentity;
            string fdlang = "";
            IEnumerable<Claim> claims = identity.Claims;
        ...
        [HttpDelete]
        public async Task<HttpResponseMessage> Delete_tag([FromBody] List<int> id)
        {
            var identity = User.Identity as ClaimsIdentity;
            IEnumerable<Claim> claims = identity.Claims;
            try
        ...
        [HttpPut]
        public async Task<HttpResponseMessage> Update_Tag_Status(Trangthai trangthai)
        {
            var identity = User.Identity as ClaimsIdentity;
            IEnumerable<Claim> claims = identity.Claims;
            try
